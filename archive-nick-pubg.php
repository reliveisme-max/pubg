    ...
    <div class="shop-filter-wrapper">
        <form action="" method="GET" class="filter-form">
            ...
            <div class="filter-actions">
                ...
                <a href="<?php echo get_post_type_archive_link('nick-nick-pubg'); ?>" class="btn-reset-filter"
                    style="color: #ff5e5e; font-weight: bold; margin-left: 15px; text-decoration: none; font-size: 13px; transition: 0.3s;">

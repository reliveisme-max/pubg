        ...
        <form action="" method="GET" class="filter-form">
            ...
            <div class="filter-item">
                ...
                <select name="filter_price">
                    ...
                    <option value="0-100000"
                        <?php selected(isset($_GET['filter_price']) ? $_GET['filter_price'] : '', "0-100000"); ?>>Dưới
                        100k</option>
            ...
            <div class="filter-item">
                ...
                <select name="filter_gun">
                    ...
                    <option value="no" <?php selected(isset($_GET['filter_gun']) ? $_GET['filter_gun'] : '', "no"); ?>>
                        Không súng</option>
                </select>
            </div>
            ...
            <div class="filter-item">
                ...
                <select name="filter_server">
                    ...
                    <option value="Quốc tế"
                        <?php selected(isset($_GET['filter_server']) ? $_GET['filter_server'] : '', "Quốc tế"); ?>>Quốc
                        tế</option>
                </select>
            </div>

            <div class="filter-actions-group">
                <button type="submit" class="btn-submit-filter">LỌC NGAY <i class="fa-solid fa-filter"></i></button>
...
jQuery(document).ready(function($) {
    ...
    $('#btn-toggle-filter').on('click', openFilter);
    $('#btn-close-filter, #filter-overlay').on('click', closeFilter);
});
</script>

...
<div class="container" style="padding-top: 40px; padding-bottom: 80px;">
    ...
    <div class="shop-filter-wrapper">
        <form action="" method="GET" class="filter-form">
            ...
            <div class="filter-actions" style="display: flex; align-items: center; gap: 20px; margin-top: 10px;">
                ...
                <?php if (!empty($_GET['filter_rank']) || !empty($_GET['filter_price']) || !empty($_GET['filter_gun']) || !empty($_GET['filter_server'])): ?>
                    <a href="<?php echo get_post_type_archive_link('nick-pubg'); ?>" class="btn-reset-filter"
                        style="color: #ff4d4d; font-weight: bold; text-decoration: none; font-size: 13px; transition: 0.3s; display: flex; align-items: center; gap: 8px;">

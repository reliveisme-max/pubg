            ...
            <div style="background: #111; border: 1px solid #1a1a1a; border-radius: 15px; padding: 25px;"
                ...
                <table class="table-history-fix"
                    ...
                    <thead>
                        <tr style="color: #fff; border-bottom: 2px solid #222;">
                            ...
                            <th style="padding: 15px; text-align: left;">TÀI KHOẢN</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="color: #f39c12; font-weight: 900;">#<?php the_ID(); ?></td>
                            <td>
                                <div class="acc-secret-wrapper">
                                    ...
                                    <div class="divider-fix"
                                        style="width:1px; height:15px; background:#222; margin: 0 5px;"></div>
                                    <div class="acc-secret-item">
                                        <label>MK:</label> <span
                            ...
                            <td class="td-date-fix" style="text-align: right; color: #bbb;">
                                <?php echo get_the_modified_date('d/m/Y'); ?><br><?php echo get_the_modified_date('H:i'); ?>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                ...
                <table class="table-money-fix"
                    ...
                    <tbody>
                        ...
                        <?php endforeach; else: ?>
                        <tr>
                            <td colspan="4" style="text-align:center; padding: 40px; color: #fff;">Chưa có lịch sử biến
                                động.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
